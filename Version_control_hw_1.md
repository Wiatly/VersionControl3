...
Чтобы произвести слияние веток нужно переключиться на ветку-получатель и следующей командой из ветки источника принять изменения:

    git merge <souser_branche_name>
